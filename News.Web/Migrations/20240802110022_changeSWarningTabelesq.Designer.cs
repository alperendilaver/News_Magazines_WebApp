...
namespace News.Web.Migrations
{
    ...
    [Migration("20240802110022_changeSWarningTabelesq")]
    partial class changeSWarningTabelesq
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("News.Data.Data.Models.WarningComment", b =>
                {
                    ...
                    b.Property<int?>("CommentReplyReplyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CommentReplyReplyId");
            ...
            modelBuilder.Entity("News.Data.Data.Models.WarningComment", b =>
                {
                    ...
                    b.HasOne("News.Data.Data.Models.CommentReply", "CommentReply")
                        .WithMany()
                        .HasForeignKey("CommentReplyReplyId");
